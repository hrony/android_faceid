...
//									jint vid, jint pid, jint fd, jint busnum, jint devaddr, jstring serial)
	...
	static native int native_isActivate();
	...
	static native int native_reset_transfer();
...
//		return -1;
	...
	public int isAlive(){
		Log.e("xxxxx","isAlive = ");
		return native_isAlive();
	}

	public int isActivate(){
		Log.e("xxxx","isActivate = ");
		return native_isActivate();
	}
}